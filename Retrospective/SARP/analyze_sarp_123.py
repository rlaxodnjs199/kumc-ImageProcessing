...
def update_df_QCTCFD_from_VIDA_dashboard(df_QCTCFD: pd.DataFrame, df_VIDA: pd.DataFrame):
...
df_MASTER_SARP3['FU'] = df_MASTER_SARP3['EDF_ID'].apply(extract_FU).astype('int')
...
update_df_QCTCFD_from_VIDA_dashboard(df_QCTCFD, df_SARP3)
